...
const POLYGON_PRIVATE_KEY_TEST_NET = process.env.POLYGON_PRIVATE_KEY_TEST_NET !== undefined ? [process.env.POLYGON_PRIVATE_KEY_TEST_NET] : []

const SEPOLIA_RPC_URL_TEST_NET = process.env.SEPOLIA_RPC_URL_TEST_NET || "";
const SEPOLIA_PRIVATE_KEY_TEST_NET = process.env.SEPOLIA_PRIVATE_KEY_TEST_NET !== undefined ? [process.env.SEPOLIA_PRIVATE_KEY_TEST_NET] : []
